...
CREATE TABLE `t_auth_rm` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=166 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='角色菜单功能点关联表';

/*Data for the table `t_auth_rm` */

insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (127,NULL,'2017-10-24 17:32:47','3','root');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (128,NULL,'2017-10-24 17:32:47','3','img_mgr');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (129,NULL,'2017-10-24 17:32:47','3','img_mgr_view');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (130,NULL,'2017-10-24 17:32:47','3','img_view');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (135,NULL,'2017-10-24 17:33:05','2','root');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (136,NULL,'2017-10-24 17:33:05','2','img_view');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (141,NULL,'2017-10-24 17:35:12','1','root');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (142,NULL,'2017-10-24 17:35:12','1','img_mgr');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (143,NULL,'2017-10-24 17:35:12','1','img_mgr_view');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (144,NULL,'2017-10-24 17:35:12','1','img_mgr_verify');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (145,NULL,'2017-10-24 17:35:12','1','img_view');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (146,NULL,'2017-10-24 17:35:12','1','system_mgr');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (147,NULL,'2017-10-24 17:35:12','1','system_mgr_auth');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (148,NULL,'2017-10-24 17:35:12','1','system_mgr_auth_user');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (149,NULL,'2017-10-24 17:35:12','1','system_mgr_auth_role');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (150,NULL,'2017-10-24 17:35:12','1','system_mgr_dics');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (151,NULL,'2017-10-24 17:35:12','1','system_mgr_dics_transformer');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (152,NULL,'2017-10-24 17:35:12','1','system_mgr_dics_devicetype');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (153,NULL,'2017-10-24 17:35:29','4','root');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (154,NULL,'2017-10-24 17:35:29','4','system_mgr');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (155,NULL,'2017-10-24 17:35:29','4','system_mgr_auth');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (156,NULL,'2017-10-24 17:35:29','4','system_mgr_auth_user');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (157,NULL,'2017-10-24 17:35:29','4','system_mgr_auth_role');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (158,NULL,'2017-10-24 17:35:29','4','system_mgr_dics');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (159,NULL,'2017-10-24 17:35:29','4','system_mgr_dics_transformer');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (160,NULL,'2017-10-24 17:35:29','4','system_mgr_dics_devicetype');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (161,NULL,'2017-10-24 17:35:52','5','root');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (162,NULL,'2017-10-24 17:35:52','5','img_mgr');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (163,NULL,'2017-10-24 17:35:52','5','img_mgr_view');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (164,NULL,'2017-10-24 17:35:52','5','img_mgr_verify');
insert  into `t_auth_rm`(`ID`,`CREATE_USER`,`CREATE_TIME`,`ROLE_ID`,`MF_ID`) values (165,NULL,'2017-10-24 17:35:52','5','img_view');
...
CREATE TABLE `t_biz_device` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='设备';
...
insert  into `t_biz_device_img`(`id`,`desc`,`create_time`,`create_user`,`img_id`,`device_id`,`verify_status`,`verify_time`,`verify_user`,`verify_content`) values (3,'设备图A','2017-10-15 16:51:36','1','6494610f-2498-4fdd-8e07-18f9835e1751',2,'0',NULL,NULL,NULL);
...
insert  into `t_biz_wiringdiagram`(`id`,`desc`,`create_time`,`create_user`,`img_id`,`transformer_id`,`verify_status`,`verify_time`,`verify_user`,`verify_content`) values (3,'接线图3','2017-09-19 10:30:33','1','39ea2bcf-9917-41d1-ba88-a2b05afd223b',3,'1','2017-10-24 17:19:49','1','');
