...
insert  into `t_biz_device`(`id`,`name`,`type_id`,`desc`,`wiringdiagram_id`,`img_id`,`x`,`y`,`width`,`height`,`create_user`,`create_time`) values (2,'设备2',1,'',3,'fb5ca802-d283-4bfa-bff8-885a7d7bada8',74,248,49,52,'1','2017-09-19 16:26:29');
insert  into `t_biz_device`(`id`,`name`,`type_id`,`desc`,`wiringdiagram_id`,`img_id`,`x`,`y`,`width`,`height`,`create_user`,`create_time`) values (3,'设备3',2,'设备3',3,'1f24bdcc-727f-4767-808b-9c42e5e9f08d',177,41,100,50,'1','2017-10-15 18:53:55');
insert  into `t_biz_device`(`id`,`name`,`type_id`,`desc`,`wiringdiagram_id`,`img_id`,`x`,`y`,`width`,`height`,`create_user`,`create_time`) values (4,'设备1000',2,'',3,'7b073d5d-3af5-48d1-ba88-a0c7943717b1',335,53,100,100,'1','2017-10-21 11:55:37');
...
CREATE TABLE `t_biz_device_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='设备类型';

/*Data for the table `t_biz_device_type` */

insert  into `t_biz_device_type`(`id`,`name`,`create_time`,`create_user`,`state`,`par_id`) values (1,'变压器','2017-09-15 16:23:28','1','01',NULL);
insert  into `t_biz_device_type`(`id`,`name`,`create_time`,`create_user`,`state`,`par_id`) values (2,'B类变压器','2017-09-15 16:23:34','1','01',1);
insert  into `t_biz_device_type`(`id`,`name`,`create_time`,`create_user`,`state`,`par_id`) values (3,'其它','2017-10-21 11:57:39','1','01',2);
insert  into `t_biz_device_type`(`id`,`name`,`create_time`,`create_user`,`state`,`par_id`) values (4,'A类变压器','2017-11-10 17:38:22','1','01',1);
...
insert  into `t_biz_part`(`id`,`name`,`desc`,`create_time`,`create_user`,`img_id`,`x`,`y`,`width`,`height`,`type_id`,`device_img_id`) values (3,'部件21','部件21','2017-10-15 18:46:20','1','90bf8e67-a7d6-4ceb-a5d6-35e8a85220d8',72,253,47,55,2,3);
...
insert  into `t_biz_wiringdiagram`(`id`,`desc`,`create_time`,`create_user`,`img_id`,`transformer_id`,`verify_status`,`verify_time`,`verify_user`,`verify_content`) values (3,'接线图3','2017-09-19 10:30:33','1','39ea2bcf-9917-41d1-ba88-a2b05afd223b',3,'0',NULL,NULL,NULL);
