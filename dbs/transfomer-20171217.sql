...
insert  into `t_biz_wiringdiagram`(`id`,`desc`,`create_time`,`create_user`,`img_id`,`transformer_id`,`verify_status`,`verify_time`,`verify_user`,`verify_content`) values (5,'岳村站一次系统图（10kV）','2017-11-11 13:56:52','1','5bdabb4e-1948-4b50-b184-3245749ac2bf',5,'0',NULL,NULL,NULL);
