...
CREATE TABLE `t_biz_device` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='设备';

/*Data for the table `t_biz_device` */

insert  into `t_biz_device`(`id`,`name`,`type_id`,`desc`,`wiringdiagram_id`,`img_id`,`x`,`y`,`width`,`height`,`create_user`,`create_time`) values (6,'岳#21',9,'',5,NULL,682,196,100,100,'1','2017-11-11 13:58:11');
insert  into `t_biz_device`(`id`,`name`,`type_id`,`desc`,`wiringdiagram_id`,`img_id`,`x`,`y`,`width`,`height`,`create_user`,`create_time`) values (7,'sdf',9,'',5,NULL,874,233,567,126,'1','2017-11-28 22:11:58');
insert  into `t_biz_device`(`id`,`name`,`type_id`,`desc`,`wiringdiagram_id`,`img_id`,`x`,`y`,`width`,`height`,`create_user`,`create_time`) values (8,'fds',9,'',5,NULL,353,66,187,99,'1','2017-11-28 22:12:03');
insert  into `t_biz_device`(`id`,`name`,`type_id`,`desc`,`wiringdiagram_id`,`img_id`,`x`,`y`,`width`,`height`,`create_user`,`create_time`) values (9,'dsfds',8,'',5,NULL,66,73,100,100,'1','2017-11-28 22:12:09');
insert  into `t_biz_device`(`id`,`name`,`type_id`,`desc`,`wiringdiagram_id`,`img_id`,`x`,`y`,`width`,`height`,`create_user`,`create_time`) values (10,'sdfds',9,'',5,NULL,753,384,138,99,'1','2017-11-28 22:12:15');
insert  into `t_biz_device`(`id`,`name`,`type_id`,`desc`,`wiringdiagram_id`,`img_id`,`x`,`y`,`width`,`height`,`create_user`,`create_time`) values (11,'123',9,'',5,NULL,0,0,100,100,'1','2017-12-17 12:44:46');
...
insert  into `t_biz_files`(`id`,`filename_src`,`filename_new`,`create_time`,`create_user`,`path`,`filetype`,`filesize`) values ('5600fa27-c967-4344-9e98-32d17bd321e5','工作照片1（单反）.JPG','5600fa27-c967-4344-9e98-32d17bd321e5.JPG','2017-12-21 21:55:06','1','wg\\2017-12-21\\5600fa27-c967-4344-9e98-32d17bd321e5.JPG','JPG',6650);
...
insert  into `t_biz_files`(`id`,`filename_src`,`filename_new`,`create_time`,`create_user`,`path`,`filetype`,`filesize`) values ('6fe0c681-e0d1-4d49-845a-4dfb2862b03a','濮会3抽压PT密度继电器压力（HGIS）.JPG','6fe0c681-e0d1-4d49-845a-4dfb2862b03a.JPG','2017-12-17 14:17:58','1','wg\\2017-12-17\\6fe0c681-e0d1-4d49-845a-4dfb2862b03a.JPG','JPG',4877);
insert  into `t_biz_files`(`id`,`filename_src`,`filename_new`,`create_time`,`create_user`,`path`,`filetype`,`filesize`) values ('a985e4f7-84e0-4f8c-9d5c-81e8cb985139','工作照片1（单反）.JPG','a985e4f7-84e0-4f8c-9d5c-81e8cb985139.JPG','2017-11-28 22:23:34','1','parthis\\2017-11-28\\a985e4f7-84e0-4f8c-9d5c-81e8cb985139.JPG','JPG',6650);
...
insert  into `t_biz_files`(`id`,`filename_src`,`filename_new`,`create_time`,`create_user`,`path`,`filetype`,`filesize`) values ('ddb2299a-ba1b-4e92-ba86-e0138f67f57b','工作照片2（单反）.JPG','ddb2299a-ba1b-4e92-ba86-e0138f67f57b.JPG','2017-12-21 21:55:48','1','wg\\2017-12-21\\ddb2299a-ba1b-4e92-ba86-e0138f67f57b.JPG','JPG',6161);
...
insert  into `t_biz_part`(`id`,`name`,`desc`,`create_time`,`create_user`,`img_id`,`x`,`y`,`width`,`height`,`type_id`,`device_img_id`) values (5,'电线','','2017-11-11 13:59:29','1',NULL,412,193,100,100,9,5);
...
CREATE TABLE `t_biz_part_his` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='部件历史';
...
insert  into `t_biz_part_his`(`id`,`create_time`,`create_user`,`img_id`,`content`,`part_id`,`verify_time`,`verify_status`,`verify_user`,`verify_content`) values (19,'2017-11-28 22:23:36','1','a985e4f7-84e0-4f8c-9d5c-81e8cb985139','sdfds',5,'2017-12-17 14:25:21','1','1','');
...
CREATE TABLE `t_biz_transformer` (
  ...
  `state` varchar(2) NOT NULL DEFAULT '01' COMMENT '状态：01-可用，02-禁用',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='变电站';

/*Data for the table `t_biz_transformer` */

insert  into `t_biz_transformer`(`id`,`name`,`type`,`desc`,`create_user`,`create_time`,`address`,`state`) values (5,'岳村站','公司所属变电站','岳村站','1','2017-11-11 13:53:48',NULL,'01');
insert  into `t_biz_transformer`(`id`,`name`,`type`,`desc`,`create_user`,`create_time`,`address`,`state`) values (6,'尧舜站','公司所属变电站','尧舜','1','2017-11-11 13:54:02',NULL,'01');
insert  into `t_biz_transformer`(`id`,`name`,`type`,`desc`,`create_user`,`create_time`,`address`,`state`) values (7,'变电站C','用户所属变电站','变电站C的描述','1','2017-11-11 13:54:13',NULL,'01');
insert  into `t_biz_transformer`(`id`,`name`,`type`,`desc`,`create_user`,`create_time`,`address`,`state`) values (8,'sdfds','公司所属变电站','','1','2017-11-28 22:12:45',NULL,'01');
insert  into `t_biz_transformer`(`id`,`name`,`type`,`desc`,`create_user`,`create_time`,`address`,`state`) values (9,'sdfsd','公司所属变电站','','1','2017-11-28 22:12:48',NULL,'01');
insert  into `t_biz_transformer`(`id`,`name`,`type`,`desc`,`create_user`,`create_time`,`address`,`state`) values (10,'sdfdsf','公司所属变电站','','1','2017-11-28 22:12:50',NULL,'01');
insert  into `t_biz_transformer`(`id`,`name`,`type`,`desc`,`create_user`,`create_time`,`address`,`state`) values (11,'sdfdsf','公司所属变电站','','1','2017-11-28 22:12:53',NULL,'01');
insert  into `t_biz_transformer`(`id`,`name`,`type`,`desc`,`create_user`,`create_time`,`address`,`state`) values (12,'sdfsdfd','公司所属变电站','','1','2017-11-28 22:12:56',NULL,'01');
insert  into `t_biz_transformer`(`id`,`name`,`type`,`desc`,`create_user`,`create_time`,`address`,`state`) values (13,'sdfdsfds','公司所属变电站','','1','2017-11-28 22:12:58',NULL,'01');
insert  into `t_biz_transformer`(`id`,`name`,`type`,`desc`,`create_user`,`create_time`,`address`,`state`) values (14,'sdfdsfd','公司所属变电站','','1','2017-11-28 22:13:01',NULL,'01');
insert  into `t_biz_transformer`(`id`,`name`,`type`,`desc`,`create_user`,`create_time`,`address`,`state`) values (15,'sdfdsf','公司所属变电站','','1','2017-11-28 22:13:12',NULL,'01');
insert  into `t_biz_transformer`(`id`,`name`,`type`,`desc`,`create_user`,`create_time`,`address`,`state`) values (16,'sdfsdf','公司所属变电站','','1','2017-11-28 22:13:15',NULL,'01');
insert  into `t_biz_transformer`(`id`,`name`,`type`,`desc`,`create_user`,`create_time`,`address`,`state`) values (17,'sdfsdfdf','公司所属变电站','','1','2017-11-28 22:13:18',NULL,'01');
insert  into `t_biz_transformer`(`id`,`name`,`type`,`desc`,`create_user`,`create_time`,`address`,`state`) values (18,'sdfdsfdsf','公司所属变电站','','1','2017-11-28 22:13:21',NULL,'01');
...
insert  into `t_biz_wiringdiagram`(`id`,`desc`,`create_time`,`create_user`,`img_id`,`transformer_id`,`verify_status`,`verify_time`,`verify_user`,`verify_content`) values (5,'岳村站一次系统图（10kV）','2017-11-11 13:56:52','1','ddb2299a-ba1b-4e92-ba86-e0138f67f57b',5,'0',NULL,NULL,NULL);

/*Table structure for table `t_log_visit` */

DROP TABLE IF EXISTS `t_log_visit`;

CREATE TABLE `t_log_visit` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `day` varchar(10) NOT NULL COMMENT '天',
  `count` int(11) NOT NULL DEFAULT '0' COMMENT '访问量',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

/*Data for the table `t_log_visit` */

insert  into `t_log_visit`(`id`,`day`,`count`) values (1,'2017-12-17',12);
insert  into `t_log_visit`(`id`,`day`,`count`) values (2,'2017-12-21',1);
...
insert  into `t_system_config`(`id`,`update_time`,`update_user`,`module_id`,`module_desc`,`type`,`key`,`content`) values (2,'2017-12-17 14:18:01','1','index','首页','2','右侧图片','6fe0c681-e0d1-4d49-845a-4dfb2862b03a');
