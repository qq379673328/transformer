...
import cn.com.sinosoft.bomsmgr.entity.ge.TBizWiringdiagramExample.Criteria;
import cn.com.sinosoft.bomsmgr.entity.ge.TBizWiringdiagramExample.Criterion;
import cn.com.sinosoft.bomsmgr.entity.ge.TBizWiringdiagramExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class TBizWiringdiagramSqlProvider {

    public String countByExample(TBizWiringdiagramExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("t_biz_wiringdiagram");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(TBizWiringdiagramExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("t_biz_wiringdiagram");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(TBizWiringdiagram record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("t_biz_wiringdiagram");
        ...
        if (record.getTransformerId() != null) {
            sql.VALUES("transformer_id", "#{transformerId,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(TBizWiringdiagramExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TBizWiringdiagram record = (TBizWiringdiagram) parameter.get("record");
        TBizWiringdiagramExample example = (TBizWiringdiagramExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("t_biz_wiringdiagram");
        ...
        if (record.getTransformerId() != null) {
            sql.SET("transformer_id = #{record.transformerId,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(TBizWiringdiagram record) {
        SQL sql = new SQL();
        sql.UPDATE("t_biz_wiringdiagram");
        ...
        if (record.getTransformerId() != null) {
            sql.SET("transformer_id = #{transformerId,jdbcType=INTEGER}");
        }
    ...
    protected void applyWhere(SQL sql, TBizWiringdiagramExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
