...
public class DataHandleUtil {
	 ...
	 * @return 处理之后的数据集
	 */
	public List<Map<String, Object>> privacydataHandlerItem(List<Map<String, Object>> items, String[] fields) {
	 ...
	 * @return 处理之后的数据
	 */
	public Map<String, Object> privacydataHandler(Map<String, Object> item, String[] fields) {
		if (item == null) {
			return null;
		}
	 ...
	 *            字段名
	 */
	public List<Map<String, Object>> idCardHandlerItem(List<Map<String, Object>> items, String field) {
		List<Map<String, Object>> ret = new ArrayList<Map<String, Object>>();
		Iterator<Map<String, Object>> ite = items.iterator();
		while (ite.hasNext()) {
	 ...
	 */
	public Map<String, Object> idCardHandler(Map<String, Object> item, String field) {
		if (item == null) {
			return null;
		}
	...
	private String handlerIdCard(String idCard) {
		if (idCard != null && !"".equals(idCard.trim())) {
			...
			if (idCard.length() == 15) {
				...
				idCard = idCard.substring(0, 3) + "************" + idCard.substring(15);
			} else {
				// 非法身份证位数
				return idCard;
			}
